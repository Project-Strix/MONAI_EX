...
Checkpoint, _ = optional_import("ignite.handlers", "0.4.7", exact_version, "Checkpoint")
BaseSaveHandler, _ = optional_import("ignite.handlers.checkpoint", "0.4.7", exact_version, "BaseSaveHandler")
...
if TYPE_CHECKING:
    ...
    DiskSaver, _ = optional_import("ignite.handlers", "0.4.7", exact_version, "DiskSaver")
