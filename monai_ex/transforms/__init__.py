...
CROPADER.register('LabelMorphology', LabelMorphologyD)
CROPADER.register('MedianFilter', MedianFilterD)
CROPADER.register('RandCropByPosNegLabel', RandCropByPosNegLabelD)
