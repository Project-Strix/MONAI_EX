...
from monai.transforms.io.dictionary import LoadImaged, LoadDatad
from monai_ex.transforms.io.array import LoadPNGEx
    ...
    def __init__(
        ...
        Args:
            ...
            overwriting: whether allow to overwrite existing meta data of same key.
                default is False, which will raise exception if encountering existing key.
        """
        loader = LoadPNGEx(False, dtype, grayscale)
...
LoadPNGExD = LoadPNGExDict = LoadPNGExd
